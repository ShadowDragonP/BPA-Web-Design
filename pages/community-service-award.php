...
<body>
	...
	<div class="content">
		...
		<ul>
			...
			<li>Each activity description must include a title, the organization benefitting from the project, the date that the project was completed, and the location of the project.</li>
		...
		<h3>Applications</h3>
		<ul>
			<li>Applications must be submitted using the online application and cannot be turned in via e-mail or mail.</li>
		</ul>
	</div>
